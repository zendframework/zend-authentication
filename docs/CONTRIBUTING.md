...
[create a proposal](https://github.com/zendframework/zend-authentication/issues/new).
...
2. Fork the repository (https://github.com/zendframework/zend-authentication)
